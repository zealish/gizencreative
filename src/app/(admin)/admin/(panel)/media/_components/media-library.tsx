  ...
  return (
    <div className="mt-6 space-y-4">
      ...
      {visibleFiles.length === 0 ? (
        <p className="flex-1 text-sm text-muted">{t("searchEmpty")}</p>
      ) : (
      <ul className="grid min-w-0 flex-1 grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
      ...
      {selected ? (
        <aside className="w-full shrink-0 rounded-2xl border border-black/10 bg-background p-5 lg:sticky lg:top-20 lg:w-72 dark:border-white/10 dark:bg-white/5">
          ...
          <dl className="mt-4 space-y-3 text-sm">
            <div>
              ...
              <dd className="mt-0.5 break-all font-medium">{selected.name}</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wider text-muted">
                {t("detailsType")}
